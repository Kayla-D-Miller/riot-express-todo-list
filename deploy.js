...
function updateRemoteApp() {
  return ssh.execCommand(
    'mkdir riot-express-todo-list && cp -r riot-express-todo-list-temp/* riot-exoress-todo-list/ && rm -rf riot-express-todo-list-temp', {
      cwd: '/home/ubuntu'
  });
}
...
function sshConnect() {
  ...
  ssh
    .connect({
      // TODO: ADD YOUR IP ADDRESS BELOW (e.g. '18.234.121.233')
      host: '18.234.121.233',
      username: 'ubuntu',
      privateKey: 'retd-key.pem'
    })
    .then(function() {
